...
tk.Label(win, text = f'Computer hostname: {gethostname()}', fg = 'white', bg='#0f0f0f').pack()
...
tk.Label(win, text = f'IPv4 address: {gethostbyname(gethostname())}', fg = 'white', bg='#0f0f0f').pack()
